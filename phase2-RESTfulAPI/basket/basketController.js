...
function addItemToBasket(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var basketId, _a, productId, name, quantity, itemId, modelMgr, baskets, basketIndex, newItem;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    basketId = req.params.basketId;
                    _a = req.body, productId = _a.productId, name = _a.name, quantity = _a.quantity;
                    itemId = (0, uuid_1.v4)();
                    modelMgr = new basketModelManager_1.ModelManager(BASKET_FILE);
                    return [4 /*yield*/, modelMgr.getAll()];
                case 1:
                    ...
                    if (!(basketIndex !== -1)) return [3 /*break*/, 3];
                    newItem = { itemId: itemId, productId: productId, name: name, quantity: quantity };

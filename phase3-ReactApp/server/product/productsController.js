...
var productModel = new productModel_1.ProductModel("products.json");
var getProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category, minPrice, maxPrice, products, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productModel.getProducts(category, minPrice, maxPrice)];
            case 2:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 4];
...
var getProductById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productModel.getProductById(productId)];
            case 2:
                product = _a.sent();
                if (product) {
                    res.json(product);
